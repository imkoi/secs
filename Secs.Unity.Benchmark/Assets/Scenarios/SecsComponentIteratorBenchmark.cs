...
{
    public class SecsComponentIteratorBenchmark
    {
            ...
            ref BenchmarkResult result)
        {
            ...
            foreach (var (entity, _) in world.EachWithEntity<Local>())
            {
            ...
            ref BenchmarkResult result)
        {
            ...
            foreach (var (entity, _, _) in world.EachWithEntity<Local, Remote>())
            {
                world.DestroyEntity(entity);
            }
            ...
            ref BenchmarkResult result)
        {
            ...
            foreach (var (entity, _, _, _) in world.EachWithEntity<Local, Remote, Health>())
            {
                world.DestroyEntity(entity);
            }
            ...
            ref BenchmarkResult result)
        {
            ...
            foreach (var refLocal in world.Each<Local>())
            {
                refLocal.Value.i++;
            }
            ...
            ref BenchmarkResult result)
        {
            ...
            foreach (var (refLocal, refRemote) in world.Each<Local, Remote>())
            {
                refLocal.Value.i++;
                refRemote.Value.i++;
            }
            ...
            ref BenchmarkResult result)
        {
            ...
            foreach (var (refLocal, refRemote, refHealth) in world.Each<Local, Remote, Health>())
            {
                refLocal.Value.i++;
                refRemote.Value.i++;
                refHealth.Value.i++;
