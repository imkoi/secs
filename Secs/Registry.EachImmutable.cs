    ...
    public partial class Registry
    {
           ...
           where T3 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1], dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1]);
                }
           ...
           where T4 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1], dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1]);
                }
        ...
        public delegate void EachImmutable<T0, T1, T2, T3, T4, T5>(Registry registry, T0 v0, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5)
           where T0 : struct
           where T1 : struct
           where T2 : struct
           where T3 : struct
        ...
        public unsafe void Each<T0, T1, T2, T3, T4, T5>(EachImmutable<T0, T1, T2, T3, T4, T5> each, Filter filter = default)
           where T0 : struct
           where T1 : struct
           where T2 : struct
           where T3 : struct
           ...
           where T5 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1], dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1], dense5[sparse5[entity] - 1]);
                }
        ...
        public delegate void EachImmutable<T0, T1, T2, T3, T4, T5, T6>(Registry registry, T0 v0, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6)
           where T0 : struct
           where T1 : struct
           where T2 : struct
           where T3 : struct
        ...
        public unsafe void Each<T0, T1, T2, T3, T4, T5, T6>(EachImmutable<T0, T1, T2, T3, T4, T5, T6> each, Filter filter = default)
           where T0 : struct
           where T1 : struct
           where T2 : struct
           where T3 : struct
           ...
           where T6 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1], dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1], dense5[sparse5[entity] - 1], dense6[sparse6[entity] - 1]);
                }
        ...
        public delegate void EachImmutable<T0, T1, T2, T3, T4, T5, T6, T7>(Registry registry, T0 v0, T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7)
           where T0 : struct
           where T1 : struct
           where T2 : struct
           where T3 : struct
        ...
        public unsafe void Each<T0, T1, T2, T3, T4, T5, T6, T7>(EachImmutable<T0, T1, T2, T3, T4, T5, T6, T7> each, Filter filter = default)
           where T0 : struct
           where T1 : struct
           where T2 : struct
           where T3 : struct
           ...
           where T7 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1], dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1], dense5[sparse5[entity] - 1], dense6[sparse6[entity] - 1], dense7[sparse7[entity] - 1]);
                }
