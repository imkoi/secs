...
namespace Secs
{
    public partial class Registry
    {
        ...
        public ComponentIteratorWithEntity<T0, T1, T2, T3, T4> EachWithEntity<T0, T1, T2, T3, T4>(
        ...
        public ComponentIteratorWithEntity<T0, T1, T2, T3, T4, T5> EachWithEntity<T0, T1, T2, T3, T4, T5>(
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public ComponentIteratorWithEntity<T0, T1, T2, T3, T4, T5, T6> EachWithEntity<T0, T1, T2, T3, T4, T5, T6>(
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public ComponentIteratorWithEntity<T0, T1, T2, T3, T4, T5, T6, T7> EachWithEntity<T0, T1, T2, T3, T4, T5, T6,
            T7>(Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
            ...
            where T7 : struct
        {
            ...
            public (int entityId, Ref<T0>, Ref<T1>, Ref<T2>, Ref<T3>, Ref<T4>, Ref<T5>, Ref<T6>, Ref<T7>) Current
            {
                get;
                set;
            }
