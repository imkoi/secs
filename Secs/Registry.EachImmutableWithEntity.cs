...
namespace Secs
{
    public partial class Registry
    {
        ...
        public delegate void EachImmutableWithEntity<T0, T1, T2, T3>(Registry registry, int entity, T0 v0, T1 v1, T2 v2,
            T3 v3)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3>(EachImmutableWithEntity<T0, T1, T2, T3> each,
            ...
            where T3 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                {
                    each(this, entity, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1],
                        dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1]);
                }
        ...
        public delegate void EachImmutableWithEntity<T0, T1, T2, T3, T4>(Registry registry, int entity, T0 v0, T1 v1,
            T2 v2, T3 v3, T4 v4)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4>(EachImmutableWithEntity<T0, T1, T2, T3, T4> each,
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            ...
            where T4 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                {
                    each(this, entity, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1],
                        dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1]);
                }
        ...
        public delegate void EachImmutableWithEntity<T0, T1, T2, T3, T4, T5>(Registry registry, int entity, T0 v0,
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4, T5>(EachImmutableWithEntity<T0, T1, T2, T3, T4, T5> each,
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public delegate void EachImmutableWithEntity<T0, T1, T2, T3, T4, T5, T6>(Registry registry, int entity, T0 v0,
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4, T5, T6>(
            EachImmutableWithEntity<T0, T1, T2, T3, T4, T5, T6> each, Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
            ...
            where T6 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, entity, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1],
                        dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1],
                        dense5[sparse5[entity] - 1], dense6[sparse6[entity] - 1]);
                }
        ...
        public delegate void EachImmutableWithEntity<T0, T1, T2, T3, T4, T5, T6, T7>(Registry registry, int entity,
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4, T5, T6, T7>(
            EachImmutableWithEntity<T0, T1, T2, T3, T4, T5, T6, T7> each, Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
            ...
            where T7 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, entity, dense0[sparse0[entity] - 1], dense1[sparse1[entity] - 1],
                        dense2[sparse2[entity] - 1], dense3[sparse3[entity] - 1], dense4[sparse4[entity] - 1],
                        dense5[sparse5[entity] - 1], dense6[sparse6[entity] - 1], dense7[sparse7[entity] - 1]);
                }
