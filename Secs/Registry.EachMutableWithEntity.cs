...
namespace Secs
{
    public partial class Registry
    {
        ...
        public delegate void EachMutableWithEntity<T0, T1, T2>(Registry registry, int entity, ref T0 v0, ref T1 v1,
            ref T2 v2)
            where T0 : struct
            where T1 : struct
            where T2 : struct;
        ...
        public delegate void EachMutableWithEntity<T0, T1, T2, T3>(Registry registry, int entity, ref T0 v0, ref T1 v1,
            ref T2 v2, ref T3 v3)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3>(EachMutableWithEntity<T0, T1, T2, T3> each,
            ...
            where T3 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                {
                    each(this, entity, ref dense0[sparse0[entity] - 1], ref dense1[sparse1[entity] - 1],
                        ref dense2[sparse2[entity] - 1], ref dense3[sparse3[entity] - 1]);
                }
        ...
        public delegate void EachMutableWithEntity<T0, T1, T2, T3, T4>(Registry registry, int entity, ref T0 v0,
            ref T1 v1, ref T2 v2, ref T3 v3, ref T4 v4)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4>(EachMutableWithEntity<T0, T1, T2, T3, T4> each,
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public delegate void EachMutableWithEntity<T0, T1, T2, T3, T4, T5>(Registry registry, int entity, ref T0 v0,
            ref T1 v1, ref T2 v2, ref T3 v3, ref T4 v4, ref T5 v5)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4, T5>(EachMutableWithEntity<T0, T1, T2, T3, T4, T5> each,
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            ...
            where T5 : struct
        {
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, entity, ref dense0[sparse0[entity] - 1], ref dense1[sparse1[entity] - 1],
                        ref dense2[sparse2[entity] - 1], ref dense3[sparse3[entity] - 1],
                        ref dense4[sparse4[entity] - 1], ref dense5[sparse5[entity] - 1]);
                }
        ...
        public delegate void EachMutableWithEntity<T0, T1, T2, T3, T4, T5, T6>(Registry registry, int entity, ref T0 v0,
            ref T1 v1, ref T2 v2, ref T3 v3, ref T4 v4, ref T5 v5, ref T6 v6)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4, T5, T6>(
            EachMutableWithEntity<T0, T1, T2, T3, T4, T5, T6> each, Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public delegate void EachMutableWithEntity<T0, T1, T2, T3, T4, T5, T6, T7>(Registry registry, int entity,
        ...
        public unsafe void EachWithEntity<T0, T1, T2, T3, T4, T5, T6, T7>(
            EachMutableWithEntity<T0, T1, T2, T3, T4, T5, T6, T7> each, Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
            ...
            if (entityIndex >= 0)
            {
                ...
                if (match)
                {
                    each(this, entity, ref dense0[sparse0[entity] - 1], ref dense1[sparse1[entity] - 1],
                        ref dense2[sparse2[entity] - 1], ref dense3[sparse3[entity] - 1],
                        ref dense4[sparse4[entity] - 1], ref dense5[sparse5[entity] - 1],
                        ref dense6[sparse6[entity] - 1], ref dense7[sparse7[entity] - 1]);
                }
