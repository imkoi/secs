    ...
    public partial class Registry
    {
           ...
           where T1 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, });
                Current = _current;
            }
           ...
           where T2 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, }, new Ref<T2>{ _sparse = sparse2, _dense = dense2, });
                Current = _current;
            }
           ...
           where T3 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, }, new Ref<T2>{ _sparse = sparse2, _dense = dense2, }, new Ref<T3>{ _sparse = sparse3, _dense = dense3, });
                Current = _current;
            }
           ...
           where T4 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, }, new Ref<T2>{ _sparse = sparse2, _dense = dense2, }, new Ref<T3>{ _sparse = sparse3, _dense = dense3, }, new Ref<T4>{ _sparse = sparse4, _dense = dense4, });
                Current = _current;
            }
           ...
           where T5 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, }, new Ref<T2>{ _sparse = sparse2, _dense = dense2, }, new Ref<T3>{ _sparse = sparse3, _dense = dense3, }, new Ref<T4>{ _sparse = sparse4, _dense = dense4, }, new Ref<T5>{ _sparse = sparse5, _dense = dense5, });
                Current = _current;
            }
           ...
           where T6 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, }, new Ref<T2>{ _sparse = sparse2, _dense = dense2, }, new Ref<T3>{ _sparse = sparse3, _dense = dense3, }, new Ref<T4>{ _sparse = sparse4, _dense = dense4, }, new Ref<T5>{ _sparse = sparse5, _dense = dense5, }, new Ref<T6>{ _sparse = sparse6, _dense = dense6, });
                Current = _current;
            }
        ...
        public ComponentIterator<T0, T1, T2, T3, T4, T5, T6, T7> Each<T0, T1, T2, T3, T4, T5, T6, T7>(Filter filter = default)
           where T0 : struct 
           where T1 : struct 
           where T2 : struct 
           where T3 : struct 
           ...
           where T7 : struct
        {
            ...
            public ComponentIterator(Registry registry, Filter filter)
            {
                ...
                _includesCount = includesCount - 1;
                _finalFilterCount = finalFilterCount;
                _current = (new Ref<T0>{ _sparse = sparse0, _dense = dense0, }, new Ref<T1>{ _sparse = sparse1, _dense = dense1, }, new Ref<T2>{ _sparse = sparse2, _dense = dense2, }, new Ref<T3>{ _sparse = sparse3, _dense = dense3, }, new Ref<T4>{ _sparse = sparse4, _dense = dense4, }, new Ref<T5>{ _sparse = sparse5, _dense = dense5, }, new Ref<T6>{ _sparse = sparse6, _dense = dense6, }, new Ref<T7>{ _sparse = sparse7, _dense = dense7, });
                Current = _current;
            }
