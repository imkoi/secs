...
namespace Secs
{
    public partial class Registry
    {
        ...
        public delegate void EachMutable<T0, T1, T2, T3, T4>(Registry registry, ref T0 v0, ref T1 v1, ref T2 v2,
            ref T3 v3, ref T4 v4)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public delegate void EachMutable<T0, T1, T2, T3, T4, T5>(Registry registry, ref T0 v0, ref T1 v1, ref T2 v2,
            ref T3 v3, ref T4 v4, ref T5 v5)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public unsafe void Each<T0, T1, T2, T3, T4, T5>(EachMutable<T0, T1, T2, T3, T4, T5> each,
        ...
        public delegate void EachMutable<T0, T1, T2, T3, T4, T5, T6>(Registry registry, ref T0 v0, ref T1 v1, ref T2 v2,
            ref T3 v3, ref T4 v4, ref T5 v5, ref T6 v6)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public unsafe void Each<T0, T1, T2, T3, T4, T5, T6>(EachMutable<T0, T1, T2, T3, T4, T5, T6> each,
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        ...
        public delegate void EachMutable<T0, T1, T2, T3, T4, T5, T6, T7>(Registry registry, ref T0 v0, ref T1 v1,
            ref T2 v2, ref T3 v3, ref T4 v4, ref T5 v5, ref T6 v6, ref T7 v7)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        public unsafe void Each<T0, T1, T2, T3, T4, T5, T6, T7>(EachMutable<T0, T1, T2, T3, T4, T5, T6, T7> each,
            Filter filter = default)
            where T0 : struct
            where T1 : struct
            where T2 : struct
